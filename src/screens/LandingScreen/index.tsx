...
class Landing extends React.Component<Props> {
	...
	public renderSliderBlock() {
		return (
			<div className="container mt-2 carousel pg-landing-screen_slider-carousel">
			  <ImageSlider />
			</div>
		);
    }
        ...
        return (
            <div className="pg-landing-screen__platform-info">
                <div className="pg-landing-screen__platform-info__wrap">
                    ...
                    <div className="pg-landing-screen__platform-info__wrap__item">
                        <span>{this.translate('page.body.landing.platformInfo.item.fourth.value')}</span>
                        <span>{this.translate('page.body.landing.platformInfo.item.fourth.title')}</span>
                    </div>
                </div>
            </div>
        );
    ...
    public renderTrustWorthyBlock() {
        return (
            <div className="pg-landing-screen__trustworthy">
                <div className="pg-landing-screen__trustworthy__wrap">
                    <h1>{this.translate('page.body.landing.trustworthy.title')}</h1>
                    <div className="pg-landing-screen__trustworthy__content">
                        <div className="pg-landing-screen__trustworthy__content__row">
                            <div className="pg-landing-screen__trustworthy__content__row__item">
                                <img
                                    src={TrustWorthySecureIcon}
                                    alt={this.translate('page.body.landing.trustworthy.trustworthy.item1.title')}
                                />
                                <h2>{this.translate('page.body.landing.trustworthy.trustworthy.item1.title')}</h2>
                                <span>{this.translate('page.body.landing.trustworthy.trustworthy.item1.text')}</span>
                            </div>
                            <div className="pg-landing-screen__trustworthy__content__row__item">
                                <img
                                    src={TrustWorthyComplianceIcon}
                                    alt={this.translate('page.body.landing.trustworthy.trustworthy.item2.title')}
                                />
                                <h2>{this.translate('page.body.landing.trustworthy.trustworthy.item2.title')}</h2>
                                <span>{this.translate('page.body.landing.trustworthy.trustworthy.item2.text')}</span>
                            </div>
                            <div className="pg-landing-screen__trustworthy__content__row__item">
                                <img
                                    src={TrustWorthyUserIcon}
                                    alt={this.translate('page.body.landing.trustworthy.trustworthy.item3.title')}
                                />
                                <h2>{this.translate('page.body.landing.trustworthy.trustworthy.item3.title')}</h2>
                                <span>{this.translate('page.body.landing.trustworthy.trustworthy.item3.text')}</span>
                            </div>
                        </div>
                    </div>
                </div>

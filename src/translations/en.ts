...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'The Global Digital Coin Exchange',
    'page.body.landing.marketInfo.title.text2': 'Where Innovative Digital Assets Gather',
    ...
    'page.body.landing.trustworthy.trustworthy.item1.title': 'Secure & Stable',
    'page.body.landing.trustworthy.trustworthy.item2.title': 'Professional & Compliant',
    'page.body.landing.trustworthy.trustworthy.item3.title': 'User-First',
    ...
    'page.body.landing.trustworthy.trustworthy.item1.text': 'With top technical team, all-round security protection and our proprietary high-speed matching engine, we guarantee stability under concurrency of thousands of orders, each one of which will be in good hands.',
    'page.body.landing.trustworthy.trustworthy.item2.text': 'Apart from our operation team with rich experience in blockchain and financial industry, we have a 100% reserve guarantee and have obtained a legal license of digital asset.',
    'page.body.landing.trustworthy.trustworthy.item3.text': 'Serving global users with 24/7 exchange services, multilingual support, strong community backup, and professional customer service.',

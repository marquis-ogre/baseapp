...
export const ru: LangType = {
    ...
    'page.body.landing.trustworthy.trustworthy.item2.text': 'By joining in CoinEx Ambassador Team, our Ambassadors can deeply involve in the exchanges marketing operations and make joint efforts to create a global business ecosystem.',
